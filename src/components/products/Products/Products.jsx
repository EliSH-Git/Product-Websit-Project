      ...
      <div className="products-container">
        ...
        {ringImgList.length === 0 ? (
          ...
          <div className="product-list">
            {ringImgList.slice(53, 59).map((item) => (
            ...
            <div className="product-list-section-three">
              <div className="div-img-HOLIDAY">
                <img
                  ...
                  src="src/components/products/Products/img/HOLIDAY-ring.webp"
                  alt=" HOLIDAY-RING "
                />
              </div>
      ...
      <section className="section-5-HOLIDAY-armband">
        <div className="div-holiday-armband">
          <img
            ...
            src="src/components/products/Products/img/HOLIDAY-armBand.webp"
            alt=" HOLIDAY-ARMBAND "
          />
        </div>
        <div>
